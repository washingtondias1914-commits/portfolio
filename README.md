...
1. 01 - Rede Corporativa Completa
   - O que demonstra: VLANs, IP addressing, DHCP, DNS, NAT, roteamento inter-VLAN, ACLs, OSPF
   - Link: ./01-rede-corporativa/README.md

2. 02 - Infraestrutura Cisco
   - O que demonstra: switching, routing, VLAN, STP, EtherChannel, OSPF, troubleshooting
   - Link: ./02-infraestrutura-cisco/README.md

3. 03 - Servidor Linux Empresarial
   - O que demonstra: administração de servidores (Ubuntu/RHEL), usuários/permissões, SSH seguro, firewall, serviços (Nginx), automação básica
   - Link: ./03-linux-server/README.md

4. 04 - Servidores + Monitoramento
   - O que demonstra: provisionamento de servidores, configuração de monitoramento (Zabbix/Prometheus), dashboards Grafana, centralização de logs (ELK)
   - Link: ./04-monitoramento/README.md

5. 05 - Projeto Integrado (Infraestrutura Completa)
